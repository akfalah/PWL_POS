...
@section('content')
    ...
    <table class="table table-bordered">
        <tr>
            <th width="30px" class="text-center">User id</th>
            <th width="75px" class="text-center">Level id</th>
        ...
        <tr>
            ...
            <td class="text-center">
                ...
                <form action="{{ route('m_user.destroy',$m_user->user_id) }}" method="POST">
                    <a class="btn btn-success btn-sm" href="{{ route('m_user.show',$m_user->user_id) }}">Show</a>
